...
- After opening a pull request, or when the session brief lists open ones, offer to run `pr-sweep` on them; the skill says how to ask and what a yes sets in motion.
