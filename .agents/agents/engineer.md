...
| --- | --- |
| a PDD, BRD, PRD, EARS or BDD document, or an interview record, to write | hand to the `business-analyst` agent; the chain in `AGENTS.md` starts there, and TRD, RFC, ADR, SPEC and IPLAN are yours |
